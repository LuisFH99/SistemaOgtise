...
<body>
    ...
    <p>Estimado(a) Sr(a):  {{$credenciales["docente"]}} perteneciente a la UNIVERSIDAD NACIONAL SANTIAGO ANTUNEZ DE MAYOLO, mediante la presente se le hace entrega de sus credenciales para el Acceso al Sistema de Gestión de Asistencia Docente:</p>
